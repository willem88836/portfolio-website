...
{
	/// <summary>
	///		Represents one chapter of the interactive video. 
	///		This is a combination of one videofile and a number of TimelineEvents.
	/// </summary>
	[Serializable]
	public class TimelineChapter
	{
		...
		/// <summary>
		///		Returns the eventlist in chronological order of invokation time.
		/// </summary>
		public List<TimelineEventData> GetChronologicalList()
		{
